...
- [ ] **AC-3**: Given two players on the same team with last_name="<NAME-REDACTED>", first_names "O" and "<NAME-REDACTED>", the function returns the pair with "<NAME-REDACTED>" as canonical.
