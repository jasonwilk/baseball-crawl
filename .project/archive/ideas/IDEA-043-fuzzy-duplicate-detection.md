...
## Summary
Extend the duplicate detection in E-155 from exact name matching to fuzzy matching (Levenshtein distance, token overlap, suffix stripping). Would catch "<CITY-REDACTED> East" vs "<CITY-REDACTED> East HS" vs "L. East" as potential duplicates.
...
## Notes
Coach consultation (E-155 discovery) identified this as important but not MVP. "<CITY-REDACTED> East" vs "<CITY-REDACTED> East HS" vs "L. East" are the typical patterns.

**Primary real-world gap (E-155 review, Coach-2)**: Cross-source name variants are likely the most common duplicate scenario. The schedule loader creates "<CITY-REDACTED> East HS" (from schedule data), the resolver finds "<CITY-REDACTED> East" (the canonical GC name). E-155's exact-name matching won't flag these. This makes fuzzy matching the highest-impact improvement for duplicate detection coverage.
