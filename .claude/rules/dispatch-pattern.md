...
1. **Main session (spawner + router)** -- Creates the team, assigns stories, routes completion reports, manages merge-back and cascade, runs closure. MUST NOT write code, update status files, or verify ACs.
