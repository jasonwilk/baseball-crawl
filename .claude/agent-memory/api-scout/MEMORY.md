...
- [public-team-profile-season-shape.md](public-team-profile-season-shape.md) -- cached sample shows team_season.season = bare string + year FLAT at team_season.year, contradicting doc's team_season.season.year object AND testing.md; UNVERIFIED single sample, needs live confirm (public endpoint, cheap) before rewriting docs (2026-07-07, E-255/CE-5)
...
- [search-opponent-import-regression.md](search-opponent-import-regression.md) -- GET /search/opponent-import 400s on its own documented example while doc reads CONFIRMED LIVE 2026-03-09; 415 on guessed Accept => likely version pin, needs captured curl; nothing depends on it post-E-168 (2026-07-25)
