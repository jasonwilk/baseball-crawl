...
## Scouting Report Feature Consultations
...
- [IDEA-217 record header consultation (2026-07-27)](idea-217-record-header-consultation.md) -- Record must count games PLAYED not data-bearing games (asymmetric detectability + diagnostic-value-of-divergence arguments); row cleanup (IDEA-218/219) is the correct fix, not narrowing the query
