...
- E-143 (COMPLETED): Admin Management Overhaul -- 8 stories (01, 02, 02b, 03, 04, 05, 06a, 06). Program list+create admin page (01), user role schema migration (02), admin role enforcement (02b), delete deactivated zero-data teams (03), opponent mapping UX polish (04), per-team crawl pipeline scoping (05), crawl_jobs schema migration (06a), crawl trigger UI with status display (06). Migrations 003 (users.role) and 004 (crawl_jobs). Background pipeline trigger pattern (src/pipeline/trigger.py). Admin UI now primary operational interface. SE + DE. Archived 2026-03-21.
