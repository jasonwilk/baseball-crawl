...
- **Next epic: E-279 · next migration: 013 · next idea: 231.** (E-278 COMPLETED 2026-07-28; ideas 222-230 filed across it and its aftermath — 230 by claude-architect, whose own-directory rule kept it out of this file. Globbed 2026-07-28: 230 files, max 230, all nine of 222-230 carry index rows. No migration.) **This line said "227", then "229", within one closure — falsified TWICE by its own author's later writes. Nothing about the sentence changed either time. Glob the live dir; never trust this counter.**
