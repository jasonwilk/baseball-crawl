...
## Numbering State
- **Next available epic number: E-264.** READY: E-263 (Deep Scout v1 — opponent-intelligence report sections, **10 stories**, READY 2026-07-13) + E-262 (Post-Program Housekeeping, 8 active + 1 abandoned, READY 2026-07-12) + E-261 (Cross-Perspective Game-Dedup Fidelity, READY, 5 stories, 2026-07-12) — see Active Epics below. Everything E-260 and below is COMPLETED+archived — see [archived-epics.md](archived-epics.md) (canonical `ls /.project/archive/`). CE-1..CE-5 = E-251..E-255.
- **Next available idea number: IDEA-136** (ALWAYS glob `.project/ideas/` before assigning — counter goes stale; descriptions in `/.project/ideas/README.md`). 131-135 filed 2026-07-13 (E-263 planning): 131 signal-catalog/discovery-pass meta-artifact, 132 `--vs`/`--date` matchup paradigm, 133 Deep-Scout-v2 LLM two-pass (model-eval-gated), 134 play-level cross-perspective duplication (Fable Note A), 135 `shf`=sacrifice-flies data-dict fix (Fable Note B). 010/022/105/107/111/113/114/117/118/122/123/126/127/128 PROMOTED → E-262; 078 + 092 DISCARDED.
...
- **E-262 READY (2026-07-12)**: Post-Program Housekeeping — 2026-07 sweep tail (7 audit residuals + 10 fold-ins + 4 live bugs). 8 active stories (01–07, 09; 08 ABANDONED tombstone needs team-lead `git rm`); scorecard 25/25/0. Full mapping + dispositions in `epics/E-262-*/epic.md`. **Dispatch reminder:** E-262-05 edits perspective-provenance.md (128) — confirm no E-261/E-263 file collision.
- **E-261 READY (2026-07-12)**: Cross-Perspective Game-Dedup Fidelity — fixes GameLoader's two dedup defects (game_stream_id clobber; exact-score gate) rendering complete reports `degraded`. 5 stories (`bb data merge-duplicate-games` in 04); scorecard 27/27. 60-day freshness clock from 2026-07-12. Residual: tombstone `E-261-03-*.md` needs team-lead `git rm`. Full detail in `epics/E-261-*/epic.md`. (IDEA-134 = play-level dup, an out-of-E-261-scope sibling question.)
...
- **CR-vs-Codex gap re-measurement** (E-258-04 item 25): fires when ≥5 epics close after 2026-07-08 with a Review-Scorecard table. Count = 4 of 5 as of 2026-07-12 sweep — NOT yet, do not fabricate figures. Full fire-condition + procedure: [project_cr_codex_gap_remeasurement.md](project_cr_codex_gap_remeasurement.md).
