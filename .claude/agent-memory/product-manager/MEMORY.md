...
| E-137 | Epic-Level Worktree Isolation | READY | 9 stories, 3 waves. Isolate epic changes in dedicated worktree. Story patches merge to epic worktree (not main checkout). Closure merges epic worktree to main. Triage simplification (fix all real findings). CA only. |
| E-138 | Full Dispatch Pipeline | READY | 3 stories, sequential. "and review" = codex review → CR integration review → commit. Graceful degradation for large diffs. Codex prompt bug fix. Depends on E-137. CA only. |
