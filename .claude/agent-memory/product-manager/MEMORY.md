...
| E-196 | Pitching Availability and Game Ordering | ARCHIVED | Completed 2026-04-03. 5 stories delivered. Migration 014 (start_time + timezone on games). Game ordering convention (start_time tiebreaker). `get_pitching_workload()` shared query. Rest/Last + P(7d) columns on all pitching surfaces (dashboard + report). JS dual-mode rendering for standalone reports. 62 tests, 11 review findings (11 accepted, 0 dismissed). Context-layer: T1, T2, T4, T6 fire. Docs update warranted. |
...
| IDEA-039 | Game Metadata Enrichment | CANDIDATE | 2026-06-14 | E-196 delivered start_time + timezone. Remaining: venue_name, is_doubleheader, game_num_in_week. Supports IDEA-038. |
...
## Topic File Index
- [archived-epics.md](archived-epics.md) -- Complete list of archived epics with summary descriptions (E-001 through E-202)
