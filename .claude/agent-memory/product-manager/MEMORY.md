...
| E-185 | Scouting Report Redesign | READY | 2 stories: enrich data pipeline (01), redesign template (02). Heat-map color coding, key players callout, K%/BB%/PA/SB-CS columns, sort by IP/PA, team spray chart, recent form chips, print-optimized. SE only. 33 review findings (27 accepted, 3 dismissed). |
