...
| E-152 | Schedule-Based Opponent Discovery | READY | 2 stories (sequential). Seeder extracts opponents from schedule.json+opponents.json into opponent_links; wiring integrates seeder+OpponentResolver into run_member_sync. SE only. ~25 review findings accepted across 4 review passes. |
...
## Topic File Index
- [archived-epics.md](archived-epics.md) -- Complete list of archived epics with summary descriptions (E-001 through E-151)
