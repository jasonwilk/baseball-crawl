...
| E-204 | Starter vs. Relief Appearance Tracking | READY | 3 stories: schema+loader (01), backfill CLI (02), GS/GR display+sorting (03). `appearance_order INTEGER` on `player_game_pitching`. Combined GS/GR column on all pitching surfaces. 16 review findings (12 accepted, 4 dismissed). SE only. |
