...
| E-173 | Fix Opponent Scouting Workflow End-to-End | DRAFT | 6 stories: resolution write-through (01), auto-scout trigger (02), unified resolve page (03), dashboard sort+status (04), terminology cleanup (05), data repair CLI (06). Fixes broken opponent→dashboard pipeline. Absorbs E-171 scope. SE only. 3 review iterations complete. |
