...
| E-197 | Derive season_id from Team Context | READY | 4 stories: derivation utility (01), member-team loaders (02), scouting pipeline loaders (03), data migration (04). Decouples DB season_id from filesystem paths. Fixes Rebels 14U (team 126) mis-tagged as 2026-spring-hs. SE only. Execution: 01→02→03 serial, 04 independent. Migration 011. 40 review findings (30 accepted). |
| E-198 | Plays-vs-Boxscore Reconciliation Engine | READY | 2 stories: detection engine+schema+CLI dry-run (01), pitcher attribution correction+execute mode (02). Promotes IDEA-062. 11 pitcher signals + 5 batter detection + 3 game-level checks. BF-walk correction algorithm. SE only. Serial: 01→02. Migration 012. 69 review findings (51 accepted). |
...
## Topic File Index
- [archived-epics.md](archived-epics.md) -- Complete list of archived epics with summary descriptions (E-001 through E-195)
