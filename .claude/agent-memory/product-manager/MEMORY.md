...
| E-156 | Add --force Flag to bb data scout | COMPLETED | Archived 2026-03-26 |
| E-159 | Print-Optimized Scouting Report View | READY | 2 stories (SE). Print route + template, print link on existing page. |
| E-160 | Fix save_manual_opponent_link Duplicate Team Bug | READY | 1 story (SE). Fix manual connect to update teams table + set resolved_team_id. |
