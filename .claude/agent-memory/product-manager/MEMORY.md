...
| E-119 | Fix PII Scanner Discoverability | READY | 1 story (CA only). Add scanner path to CLAUDE.md Security Rules. Bug: main session tried non-existent scripts/pii_scan.py. |
...
## Topic File Index
- [archived-epics.md](archived-epics.md) -- Complete list of archived epics with summary descriptions (E-001 through E-112)
