...
| E-167 | Opponent Dedup Prevention and Resolution | READY | 4 stories: shared ensure_team_row() (01), migrate 8 INSERT paths (02), auto-merge CLI (03), admin resolution workflow with GC search (04). SE only. 31 review findings (27 accepted). Promoted from IDEA-044. |
