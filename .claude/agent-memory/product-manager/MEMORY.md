...
| E-147 | Team Season Year and Cohort Dashboard Nav | READY | 4 stories. Add season_year to teams, rewrite year map, cohort-filter dashboard. DE + SE. |
| E-148 | Review Cycle Reordering for Plan and Implement Skills | READY | 2 stories. Internal reviews before Codex in plan skill; CR before Codex in implement skill; review scorecard pattern. claude-architect only. |
...
## Topic File Index
- [archived-epics.md](archived-epics.md) -- Complete list of archived epics with summary descriptions (E-001 through E-145)
