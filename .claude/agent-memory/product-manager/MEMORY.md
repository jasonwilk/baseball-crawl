...
| E-183 | Codify Opponent Flow vs Reports Flow | ARCHIVED | 2 stories delivered: scouting data flows section in CLAUDE.md (01, CA), standalone reports coaching docs (02, docs-writer). Context-layer epic. |
| E-184 | Fix Opponent Resolver Phantom Errors | DRAFT | 2 stories: fix return type + unlinked counter (01), revert 13 E-179 test workarounds (02). SE only. Promoted from IDEA-056. |
