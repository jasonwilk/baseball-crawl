...
## Numbering State
- **Next available epic number: E-264.** READY: E-263 (Deep Scout v1 — opponent-intelligence report sections, **10 stories**, READY 2026-07-13) + E-262 (Post-Program Housekeeping, 8 active + 1 abandoned, READY 2026-07-12) — see Active Epics below. E-261 (Cross-Perspective Game-Dedup Fidelity) COMPLETED+archived 2026-07-13. Everything E-260 and below is COMPLETED+archived — see [archived-epics.md](archived-epics.md) (canonical `ls /.project/archive/`). CE-1..CE-5 = E-251..E-255.
- **Next available idea number: IDEA-137** (ALWAYS glob `.project/ideas/` before assigning — counter goes stale; descriptions in `/.project/ideas/README.md`). 136 filed 2026-07-13 (E-261 closure): Step 1d preflight `bb creds check` should scope to `web` profile only (dead mobile profile caused a false env-FAIL closure hold). 131-135 filed 2026-07-13 (E-263 planning): 131 signal-catalog/discovery-pass meta-artifact, 132 `--vs`/`--date` matchup paradigm, 133 Deep-Scout-v2 LLM two-pass (model-eval-gated), 134 play-level cross-perspective duplication (Fable Note A), 135 `shf`=sacrifice-flies data-dict fix (Fable Note B). 010/022/105/107/111/113/114/117/118/122/123/126/127/128 PROMOTED → E-262; 078 + 092 DISCARDED.
