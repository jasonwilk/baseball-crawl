...
| E-186 | Fix Spray Charts for Standalone Reports | READY | 4 stories: remove boxscore-UUID fallback + fix test failures (01), wire gc_uuid resolution via POST /search into report generator (02), correct API docs "both teams" claim (03), codify public_id-to-gc_uuid bridge pattern (04). SE + CA. Third attempt after E-158/E-176. |
