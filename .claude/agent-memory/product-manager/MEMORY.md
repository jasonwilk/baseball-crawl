...
| E-146 | Crawl Pipeline Guards and Null-Progenitor Auto-Resolution | READY | 3 stories: Phase 2 removal (01), follow→bridge→unfollow auto-resolution (02), CLI wiring (03). 01+02 parallel, 03 after 02. SE only. Defensive design for untested root_team_id→follow path. |
