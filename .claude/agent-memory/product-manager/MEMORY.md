...
| E-162 | OpponentResolver Duplicate gc_uuid Fix | COMPLETED | 1 story. Refactored _ensure_opponent_team_row to three-step SELECT lookup; added _write_gc_uuid helper. Closes duplicate-team bug with E-160. Ready to archive. |
