...
| E-149 | Review Methodology Retro and Gap-Filling | READY | 3 stories, all claude-architect. CR rubric expansion (6 new + 1 enhanced checklist items), implement skill assignment enrichment, testing rule + Codex rubric alignment. 8 review passes, 27 findings, 21 accepted. |
...
## Topic File Index
- [archived-epics.md](archived-epics.md) -- Complete list of archived epics with summary descriptions (E-001 through E-148)
