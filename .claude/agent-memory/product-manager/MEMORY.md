...
## Numbering State
- **Next available epic number: E-274** (ALWAYS glob `/epics/` + `/.project/archive/` before assigning). **E-273 COMPLETED+archived 2026-07-24** (orphan-reference-data reclamation after report deletion — see [archived-epics.md](archived-epics.md)). **E-272 READY** (2026-07-21; season×level→league classification fix + new league NRBL; 4 stories 01 NSAA_SUBVARSITY 0/1/2/3→1/2/3/4 fix→02 season×level inference+NRBL+season threading, 03 coach model-doc, 04 CA pitch-rules.md + agent-def line-33 fix; **HARDEN**: season picks family across ALL NSAA level words (Varsity→summer legion, JV/Reserve/Freshman/Frosh/Sophomore→summer nrbl, spring→NSAA, absent→NSAA default); recognized-ngb-first, mapped-bracket beats ALL name keywords, `season=="summer"` sole confirmed token→conservative NSAA default; NRBL distinct constant==LEGION; owns E-263-02c's old AC-7, E-263-02c reconciled (AC-7 superseded, AC-4 unset-delegates-to-inference); reviewed 18 findings/14 accepted across CR+holistic+Codex-iter1; proportionality-reviewed → operator KEPT as-planned (deliberate forward bet, revisit if an out-of-state 15/16U summer opp appears); **closure obl:** trigger-7 ratchet offset or operator-signed exception (E-272-04 grows context layer — NRBL in pitch-rules.md + coach doc + baseball-coach.md:33 edit)). READY awaiting operator dispatch (full detail in each epic file): **E-270** (2026-07-21; E-267 reconcile-at-load + purge hardening, 6 stories, `MAX_GAME_RETIREMENTS=2`; closure obl: docs-writer reconciles `operations.md §867-886`); **E-271** (2026-07-21; workflow/process redesign, P-1..P-10 `.project/research/E-271-e267-audit-findings.md`, CA-designed, 3 stories 01 implement-skill→02 code-reviewer + 03 disjoint; ratchet ~+35-55L operator-signed exception; closure obls: TN-13 Step-1c external-ref recon + own Closure-Evidence); **E-263** (Deep Scout v1, 2026-07-13, re-confirm by 2026-09-11 — see Active Epics below). Everything E-269 and below COMPLETED+archived — see [archived-epics.md](archived-epics.md) (canonical `ls /.project/archive/`). CE-1..CE-5 = E-251..E-255.
- **Next available idea number: IDEA-164** (ALWAYS glob `.project/ideas/` — counter goes stale; full descriptions + all statuses in `/.project/ideas/README.md`). Newest: 160=MAX_GAME_RETIREMENTS cap [E-270-01], 161=main-session durable record surface [E-271 CR S-2], 162=Step-1a-vs-1d diff-read tension [E-271 CA Codex-triage], 163=Post-Cascade Probe operator-blindness [E-273 §12, DEFERRED]. Promotions: 140→E-267, 141→E-265, 153→E-268; 010/022/105/107/111/113/114/117/118/122/123/126/127/128→E-262.
