...
| E-202 | Fix Report Generator Team Dedup Bug | READY | 1 story. Backfill public_id in generator.py after step-3 name match (separate UPDATE, inside existing force-update block). Fixes duplicate team creation during report generation. SE only. 14 findings (10 accepted). |
