...
**Second recurring lesson: agreement with a DERIVATIVE is not corroboration** (third instance this epic). Story 05 AC-9 and IDEA-187 both put a paragraph in the DE file's *"last third"*; it is at **line 21 of 35**. They agreed because one was written from the other. **Tell: two sources agreeing on a detail NEITHER NEEDED** — the signature of copying, not observation. Open the primary; never consult a summary of it.
