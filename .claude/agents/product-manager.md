...
5. **Execution**: The main session coordinates dispatch (see `/.claude/rules/dispatch-pattern.md`). PM's role is limited to setting the epic to READY and presenting it to the user for dispatch authorization.
