...
<!-- READY 2026-07-19. Context-layer epic: claude-architect owns the design (design brief) and implements
     the dispatched story; PM framed the ACs + authored the epic/story. Codex spec-review round 1 (2
     findings, both accepted + fixed) verified clean (see Review Scorecard in History). NOT dispatched —
     awaits explicit user dispatch authorization. -->
...
|----|-------|--------|-------------|----------|
| E-269-01 | Harden the PM READY Quality-Checklist gate (story-file existence + consultation completeness) | TODO | None | - |
