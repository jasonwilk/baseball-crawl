...
**Three things the operator should weigh:**
...
- **No new player-line cap.** With the gate honest, full churn refuses on the standalone `fresh_count > 0` check before any ratio is consulted. Adding a cap would mask this epic's own regression tests exactly as the roster cap masks the roster gate today — shipping a second copy of the defect that hid the first.
...
|----|-------|--------|-------------|----------|
| E-276-01 | Shared gate primitive + player-line grain | TODO | None | - |
| E-276-02 | Game grain | TODO | E-276-01 | - |
| E-276-03 | Roster grain | TODO | E-276-01, E-276-02 | - |
| E-276-04 | End-to-end churn regression through `generate_report()` | TODO | E-276-01 | - |
| E-276-05 | Correct the context-layer prose the fix falsifies | TODO | E-276-01, E-276-02, E-276-03 | - |
...
> | **player-line** | corrected gate | design **not reopened**; the dedup sweep closes the one-run window in both dominant shapes. Residues below. |
...
**9 direct helper call sites** need the new required keyword argument. **This is a WHOLE-EPIC inventory and MUST be split by story — story 01 must not cite all 9 as its own** [PM-VERIFIED, exact line numbers re-measured 2026-07-25]:

| Story | File | Sites | Lines |
|---|---|---|---|
| **01** | `tests/test_player_line_reconcile.py` | **1** | 934 |
| **02** | `tests/test_game_grain_reconcile.py` | **6** | 900, 1298, 1367, 1437, 1464, 1494 |
| **03** | `tests/test_roster_grain_reconcile.py` | **2** | 914, 923 |
...
| Claim | Verdict |
|---|---|
| 9 direct helper call sites — game ×6, player-line ×1, roster ×2 | **CORRECT**, including the per-file split (game 900/1298/1367/1437/1464/1494, player-line 934, roster 914/923) |
