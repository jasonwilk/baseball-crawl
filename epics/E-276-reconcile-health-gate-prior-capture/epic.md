...
**The artifact was edited again on 2026-07-26, AFTER that re-affirmation** — the operator's red-team repairs **R2–R5** (History, top entry). **No design change; READY is not disturbed and is not re-asserted by those edits.** Stated here because the Size section directly below assumed this file had frozen at READY and was wrong about it, and a reader who takes the date above as an as-of-last-edit marker would inherit the same mistake. **R1 is still outstanding** and arrives separately as a story 01 AC-14 rewrite.
...
| **03** | `tests/test_roster_grain_reconcile.py` | **2** | `test_previously_rostered_ids_scopes_the_cap_population` — **BOTH sites sit in this ONE test** |
