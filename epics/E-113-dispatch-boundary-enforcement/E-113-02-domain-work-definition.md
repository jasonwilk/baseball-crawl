...
- [ ] **AC-5**: The section does not duplicate the implement skill's protocol or anti-patterns. It is a standing definition (what IS domain work?) that complements the skill's in-the-moment protocol (what to DO about it). Brief cross-reference to the implement skill is acceptable.
