...
No expert consultation required -- this is a devcontainer tooling addition with no coaching, API, schema, or agent-architecture implications. SE consultation was completed by the user prior to epic formation.
...
|----|-------|--------|-------------|----------|
| E-070-01 | Add rtk to devcontainer postCreateCommand | TODO | None | - |
