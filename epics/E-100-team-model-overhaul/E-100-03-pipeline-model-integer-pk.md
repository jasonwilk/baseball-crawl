...
- [ ] **AC-10**: All existing pipeline tests pass. Tests that referenced `is_owned` or `owned_teams` are updated.
- [ ] **AC-11**: `load_config()` (YAML path) still works — YAML key renamed or mapped.
