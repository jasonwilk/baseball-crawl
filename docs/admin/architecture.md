...
| **Agent ecosystem** | Claude Code sessions | The project is developed through Claude Code sessions, with two narrow subagents for API archaeology and coaching-domain questions. See [`CLAUDE.md`](../../CLAUDE.md). |
...
baseball-crawl/
  ...
  .project/           # specs/ (the live unit of work), archive, ideas, research, templates
