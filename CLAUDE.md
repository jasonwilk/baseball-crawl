...
- **Scouting pipeline parity**: `run_scouting_sync` (web) and `bb data scout` (CLI) MUST produce equivalent data artifacts — all seven stages in both paths.
