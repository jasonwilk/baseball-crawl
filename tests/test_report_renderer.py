...
# ---------------------------------------------------------------------------
# E-229-05: Jersey-sort helper (the only piece of the legacy E-228-05
# positioning section that survives the v1 vocabulary retirement). The
# v1 vocabulary block (POSITIONING_CALL_WORDS / *_CELL_SHORT_FORMS /
# *_COLUMN_ORDER / *_POSITION_LABELS) was deleted in E-229-05 per epic
# TN-13; the test classes that exercised it (TestPositioningVocabulary-
# Constants, TestPositioningContextBuilder, TestPositioningRenderIntegration)
# were deleted with it per AC-11. New E-229 card-template tests live
# in tests/test_positioning_card_template.py and tests/test_positioning
# _card_render.py.
# ---------------------------------------------------------------------------


from src.reports.renderer import _jersey_sort_key  # noqa: E402
...
# E-229-05 deleted `TestPositioningContextBuilder` and
# `TestPositioningRenderIntegration` per AC-11: both asserted the v1
# render-context shape (`team_state_call_word == "SHADE LEFT"`,
# per-position glyph `"L Dp"`, MIXED tag in HTML, etc.) that the v2
# template supersedes. New layout / state-variant tests live in
# `tests/test_positioning_card_template.py`.
