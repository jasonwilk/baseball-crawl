...
-- E-259-03 dropped player_season_batting / player_season_pitching. The season
-- line is derived at query time from the per-game rows above, so this fixture
-- no longer seeds stored season aggregates (they would fail to insert against
-- the dropped tables).
